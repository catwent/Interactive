...
*/
function preload() {
  images[0] = loadImage('mars8.png');
  images[1] = loadImage('mars8.png');
  images[2] = loadImage('mars8.png');
  images[3] = loadImage('mars8.png');
}

function setup() {
  createCanvas(2168, 1208); // we need some space...
  /*
